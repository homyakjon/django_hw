...
with open('git_log.txt', 'w') as f:
    f.write("Last 5 comments:\n")
    for text in last_five_comments_text:
        f.write(text + '\n')

    f.write("\nDeleted comments: {}\n".format(comments_to_delete))

    f.write("\nLatest author: {}\n".format(latest_author))
    f.write("Comments before date: {}\n".format(comments_before_date))
